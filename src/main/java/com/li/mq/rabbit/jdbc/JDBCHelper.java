package com.li.mq.rabbit.jdbc;

import com.li.mq.rabbit.conf.ConfigurationManager;
import com.li.mq.rabbit.constants.Constants;
...
public class JDBCHelper {
    ...
    private JDBCHelper() {
        ...
        for (int i = 0; i < datasourceSize; i++) {
            String url = "jdbc:mysql://192.168.65.130:3306/rabbitmq-spark-streaming";
            String user = "root";
            String password = "121029";
     ...
     * @return 每条SQL语句影响的行数
     */
    public synchronized int[] executeBatch(String sql, List<Object[]> paramsList) {
        int[] rtn = null;
        Connection conn = null;
        PreparedStatement pstmt = null;
