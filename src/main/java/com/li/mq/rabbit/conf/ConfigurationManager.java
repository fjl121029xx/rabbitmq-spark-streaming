...
//					.getClassLoader().getResourceAsStream("resources/my.properties");
			FileInputStream in = new FileInputStream("D:\\work\\workspaces\\ideaProject\\rabbit-spark-streaming\\src\\main\\resources\\my.properties");
